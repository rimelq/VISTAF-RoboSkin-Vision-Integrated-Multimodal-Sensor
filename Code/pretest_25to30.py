...
IMAGE_PATTERN = "./Pretest/25to30/pretest_25to30-*.jpg"
...
def sort_key_by_index(path):
    """
    Extract an integer index from a filename of the form '...-N.ext'.
    If it fails, fallback to simple lexicographic sort key.
    """
